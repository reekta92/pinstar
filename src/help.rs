    ...
    match tab {
        ...
        PinstarHelpTab::Formats => {
            ...
            lines.push(Line::from(vec![
                Span::styled("  • ", note_style),
                Span::styled(
                    "Diamond/Stadium shapes not available in PlantUML",
                    desc_style,
                ),
            ]));
            lines.push(Line::from(vec![
                Span::styled("  • ", note_style),
                Span::styled(
                    "Color editing not available in Mermaid or PlantUML",
                    desc_style,
                ),
            ]));
            lines
